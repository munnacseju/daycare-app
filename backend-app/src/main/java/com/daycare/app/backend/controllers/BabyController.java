...
public class BabyController {
    ...
    public static final String UPDATE_BABY = "/updateBaby/{id}";
    ...
    @RequestMapping(value = UPDATE_BABY, method = RequestMethod.POST)
    @ResponseBody
    public HashMap<String, Object> updateBaby(@PathVariable Long id, @RequestBody Baby baby) {
        HashMap<String, Object> response = new HashMap<>();
        baby.setId(id);
        babyService.save(baby);
        response.put("babies", baby);
        return response;
    }
}
